...
import com.jabari.marketer.activity.UploadActivity;
    ...
    private void OnClickSend() {
        ...
        tv_register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (GlobalVariables.urls.size() == 7) {
                    OnClickRegister(et_name.getText().toString(), et_mobile.getText().toString(), et_address.getText().toString(), GlobalVariables.urls);
                } else
                    Toasty.error(RegisterDriverActivity.this, "لطفا مدارک را کامل کنید!", Toast.LENGTH_LONG, true).show();
            }
        });
    }
    ...
    private void OnClickRegister(String name, String phone, String address, List list) {
        ...
        ApiInterface.Register_driverCallback registerDriverCallback = new ApiInterface.Register_driverCallback() {
            ...
            public void onResponse(Boolean success) {
                ...
                if (success) {
                    Toasty.success(RegisterDriverActivity.this, "ثبت نام با موفقیت انجام شد!", Toast.LENGTH_LONG, true).show();

                } else
                    Toasty.success(RegisterDriverActivity.this, "ثبت نام با خطا مواجه شد!", Toast.LENGTH_LONG, true).show();
