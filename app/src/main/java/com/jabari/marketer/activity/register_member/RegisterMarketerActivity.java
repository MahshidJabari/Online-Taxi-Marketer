        ...
        ApiInterface.Register_MarketerCallback registerMarketerCallback = new ApiInterface.Register_MarketerCallback() {
            ...
            public void onResponse(String message) {
                ...
                if(message.equals("conflict")){
                    Toasty.error(RegisterMarketerActivity.this, getResources().getString(R.string.conflict), Toast.LENGTH_LONG).show();
                }
            }
            ...
            public void onFailure(String error) {
                ...
                pb_load.setVisibility(View.GONE);
                Toasty.error(RegisterMarketerActivity.this, getResources().getString(R.string.failed), Toast.LENGTH_LONG).show();
